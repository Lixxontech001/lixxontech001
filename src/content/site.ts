...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tagline: "Smart captions, scheduling and multi channel posting for busy teams.",
    description: "A SaaS tool that schedules social posts with brand tuned captions and per channel previews.",
    longDescription: "PostFlow lets marketing teams plan months of content in minutes. A Django backend orchestrates caption drafting, image suggestions, and per channel publishing via official APIs. Background workers handle scheduling, retries, and analytics ingestion. Now publishing 210K posts monthly across 340 teams.",
    highlights: [
      "Brand voice caption assistant tuned per team",
  ...
  {
    slug: "lumen",
    title: "Lumen · Legal Research Platform",
    tagline: "Fast, citation grounded case law search for boutique law firms.",
    description: "An API and dashboard that lets lawyers query case law and pull verifiable citations in seconds.",
    longDescription: "Lumen ingests jurisdiction specific case law, indexes it with pgvector and hybrid BM25 retrieval, and exposes a Django REST API that returns answers with verifiable citations. Includes a clean search frontend, a billing portal, and team level usage analytics. Trusted by 14 boutique firms.",
    highlights: [
      "pgvector + hybrid BM25 retrieval",
      "Citation grounded responses with source linking",
      "Per firm relevance tuning",
      "Usage based billing via Stripe metering",
      "SOC2 aligned access logs",
    ],
    tech: ["Django", "DRF", "pgvector", "PostgreSQL", "Next.js", "Stripe"],
